...
let handler = async (m, { conn, usedPrefix, command, text }) => {
    ...
    if (!text.includes('instagram.com')) return m.reply(`• *مثال*: ${usedPrefix + command} *[حط رابط فيديو انستجرام]*`);
    ...
    try {
        ...
        const caption = `*乂 تنزيـل - انستغـــرام*
...
handler.command = ["انستا", "instagram"];
