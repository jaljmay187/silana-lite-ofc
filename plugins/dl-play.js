/*
- الميزة: التشغيل مع Ytmp3 و ytmp4 بدون أزرار عائمة `FIXED`
- المعلومات: إعادة كتابة الكود من الأزرار العائمة السابقة باستخدام switch (command) case لتسهيل استخدام الحالات
- النوع: إضافات `ESM`
- بواسطة: HamzDxD
-  [ `المصدر` ]
